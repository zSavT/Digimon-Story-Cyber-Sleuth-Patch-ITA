# Glossario di Localizzazione - Digimon Story: Cyber Sleuth

Questo glossario definisce la terminologia ufficiale e le linee guida di adattamento per la localizzazione italiana del gioco. Lo scopo è garantire l'uniformità dei testi in tutti i file tradotti.

---

## 1. Terminologia Generale del Franchise (Digimon Universe)

| Termine Originale | Traduzione Italiana | Descrizione / Note |
| :--- | :--- | :--- |
| **Digimon** | **Digimon** | Invariante al plurale (es. "due Digimon", non "Digimons"). |
| **Tamer** | **Tamer** | Preferito a "Master" o "Maestro". Invariante per genere (es. "il Tamer", "la Tamer"). |
...
## 2. Termini Specifici di Cyber Sleuth / Hacker's Memory
...
### A. Tipi di Digimon (Types)
* **Libero** (Free)
* **Virus** (Virus)
* **Vaccino** (Vaccine)
* **Dati** (Data)

### B. Elementi / Attributi (Elements)
* **Neutrale** (Neutral)
* **Fuoco** (Fire)
* **Acqua** (Water)
* **Erba** (Plant / Wood)
* **Elettrico** (Electric / Thunder)
* **Terra** (Earth)
* **Vento** (Wind)
* **Luce** (Light)
* **Oscuro** (Dark)

### C. Stadi Evolutivi (Generations)
* **Primario** (In-Training I / Baby I)
* **Primo Stadio** (In-Training II / Baby II)
* **Intermedio** (Rookie)
* **Campione** (Champion)
* **Ultra** (Ultimate)
* **Mega** (Mega)
* **Evoluto** (Super Ultimate)
* **Armatura** (Armor)

### D. Personalità dei Digimon (Personalities)
* **Resistente** (Durable)
* **Vivace** (Lively)
* **Combattente** (Fighter)
* **Difensore** (Defender)
* **Cervellone** (Brainy)
* **Agile** (Nimble)
* **Costruttore** (Developer)
* **Ricercatore** (Searcher)

### E. Servizi di Gioco
* **DigiLab** / **Digi-Laboratorio** (DigiLab)
* **DigiFarm** (DigiFarm)
* **DigiLine** (DigiLine - la chat di messaggistica interna)
* **Field Guide** (Guida di Campo / Enciclopedia dei Digimon - nel file originale denominato *Digimon Book*)

---

## 4. Nomi dei Personaggi Chiave

### Cyber Sleuth (Protagonisti e Alleati)
* **Kyoko Kuremi**: Capo della *Kuremi Detective Agency* (Agenzia Investigativa Kuremi).
* **Nokia Shiramine**: Ragazza energica, Tamer di Agumon e Gabumon.
* **Arata Sanada**: Hacker esperto, ex leader dei Jude.
* **Yuuko Kamishiro**: Figlia del presidente della Kamishiro Enterprise.
* **Yuugo**: Il misterioso leader dei Zaxon.
* **Rie Kishibe**: Dirigente della Kamishiro Enterprise.
* **Suedou**: Scienziato eccentrico della Kamishiro Enterprise.

### Hacker's Memory (Hudie e Zaxon)
* **Keisuke Amasawa**: Protagonista (nome canonico).
* **Ryuji Mishima**: Leader carismatico del team Hudie.
* **Chitose Imai**: Vice-leader di Hudie, amichevole e spensierato.
...
## 5. Linee Guida di Stile e Adattamento

1. **Invariabilità dei nomi dei Digimon**:
   I nomi dei Digimon non assumono il plurale in "-s" (es. "i Hagurumon", non "i Hagurumons").
2. **Genere e Concordanze dei Digimon**:
   Salvo casi specifici di trama in cui un Digimon esprime una chiara identità di genere nei dialoghi, i Digimon sono da considerarsi maschili o neutri in italiano (es. "il mio Wormmon"). Fanno eccezione Digimon con fattezze e identità tipicamente femminili ampiamente definite (es. "la mia Gatomon", "la mia LadyDevimon").
3. **Uso di "Tamer"**:
   Mantenere il termine originale "Tamer" senza tradurlo in "Maestro" o "Master". Fare attenzione alla concordanza dell'articolo determinativo/indeterminativo in base al sesso del Tamer di cui si parla nei dialoghi (es. "la mia Tamer" per Tokomon/Nokia, "un bravo Tamer").
4. **Dialoghi e Punteggiatura**:
   - Usare le virgolette doppie alte (`"..."`) per i dialoghi all'interno dei testi o citazioni.
   - Preservare i caratteri speciali come `...` (tre punti) senza spazi prima e dopo se uniti al testo per pause del parlato.
